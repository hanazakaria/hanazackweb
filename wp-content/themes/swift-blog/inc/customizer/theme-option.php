...
// Setting - enable_author_detail_single_page.
$wp_customize->add_setting('enable_author_detail_single_page',
    array(
        'default' => $default['enable_author_detail_single_page'],
        'capability' => 'edit_theme_options',
        'sanitize_callback' => 'swift_blog_sanitize_checkbox',
    )
);
$wp_customize->add_control('enable_author_detail_single_page',
    array(
