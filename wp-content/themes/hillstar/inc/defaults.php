<?php
    ...
    add_action('init', function () {
        add_filter('colibri_theme_title_default_content', function($title) {
            $brite_theme_click_pen_to_edit_title = __('Create Your Own Opportunities', 'hillstar');
    ...
    $hillstar_theme_svg_icons = array(
		'fort-awesome'  => array(
	...
	$hillstar_theme_divider_style = array(
	...
	$hillstar_lorem_ipsum = "Start building your website today!";;
	...
	return array(
		...
		'lorem_ipsum'                       => $hillstar_lorem_ipsum,
		...
		'blog_post_thumb_placeholder_color' => 'rgb(160, 160, 206)',
		'assets_js_key'                     => "hillstarFrontendData",

		'default_icon'                      => $hillstar_theme_svg_icons['fort-awesome'],
		'icons'                             => $hillstar_theme_svg_icons,
		'divider_style'                     => $hillstar_theme_divider_style,
		"gradients"                         => array(
			'night_fade'  =>
				array(
					'name'  => 'night_fade',
			...
			"social_icons" => array(
				...
				"localProps" => array(
					"icons" => json_encode( array(
						array(
							'icon'       => $hillstar_theme_svg_icons['facebook-2'],
							'link_value' => 'http://www.facebook.com/',
							'index'      => 0,
						),
						array(
							'icon'       => $hillstar_theme_svg_icons['twitter-x'],
							'link_value' => '#',
							'index'      => 1,
						),
						array(
							'icon'       => $hillstar_theme_svg_icons['instagram'],
							'link_value' => '#',
							'index'      => 2,
						),
						array(
							'icon'       => $hillstar_theme_svg_icons['youtube-play'],
							'link_value' => '#',
							'index'      => 3,
						),
					) ),
			...
			"icon_list"    => array(
				...
				"localProps" => array(
					"iconList" => json_encode( array(
						array(
							'icon'       => $hillstar_theme_svg_icons['map-marker-light'],
							'text'       => 'Location, State, Country',
							'link_value' => '#',
							'index'      => 0,
						),
						array(
							'icon'       => $hillstar_theme_svg_icons['phone-2'],
							'text'       => '(000) 123 12345',
							'link_value' => 'tel:00012312345',
							'index'      => 1,
						),
						array(
							'icon'       => $hillstar_theme_svg_icons['envelope-2'],
