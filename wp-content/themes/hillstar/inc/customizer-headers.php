<?php return array (
  ...
  array (
    ...
    'data' => 
    array (
      'header_front_page.logo.props.layoutType' => 'text',
      ...
      'header_front_page.hero.hero_column_width' => 85,
      ...
      'header_front_page.hero.style.background.image.0.source.url' => '%s/../images/hero-background.jpg',
      ...
      'header_front_page.hero.style.background.overlay.color.value' => 'rgb(28, 28, 36)',
      ...
      'header_front_page.hero.style.padding.top.value' => 120,
      'header_front_page.hero.style.padding.bottom.value' => 200,
      'header_front_page.title.show' => 1,
      'header_front_page.title.localProps.content' => 'Create Your Own Opportunities',
      'header_front_page.title.style.textAlign' => 'center',
      'header_front_page.subtitle.show' => 1,
      'header_front_page.subtitle.localProps.content' => 'Start building your website today!',
