...
Hillstar is a beautiful, extremely customizable, multipurpose theme that you can use to create an amazing website by drag and drop. It comes with a predesigned home page, 5 header designs and over 35 ready to use content blocks that you can easily customize. You can also design your own custom blocks by combining over 25 drag and drop components. Hillstar has lots of customization options (video background, slideshow background, header content types, etc) that will help you create a website that stands out in no time. It is also responsive so it works on mobile devices out of the box. Hillstar is the only theme you will ever need! CHECK OUT THE DEMOS: https://hillstar.com/go/demos


== Frequently Asked Questions ==

= How can I customize Hillstar? =

    To customize the Hillstar theme you have to open the Customizer by accessing the Appearance menu -> Customizer.


== License ==

Hillstar WordPress theme, Copyright (C) 2021 ExtendThemes
Hillstar WordPress theme is licensed under the GPL3.
...
* Images
      The following SVG files are the creation of ExtendThemes and are distributed under the Creative Commons Zero License, http://creativecommons.org/publicdomain/zero/1.0/
        ...
        These assets are distributed under the CC0 License
               ...
               Source:https://www.flickr.com/photos/198663356@N04/53595180839
